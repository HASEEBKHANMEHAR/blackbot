...
✮1000 Credits + PREMIUM access - 3$
✮2000 Credits + PREMIUM access - 7$
✮4000 Credits + PREMIUM access - 9$
✮PAYMENT METHODS-:BTC,LTC,Usdt Binance
✮DM @BinnerBhaiya TO BUY
❆═══»ʙʟᴀᴄᴋ«═══❆");

$nopre = urlencode("PREMIUM REQUIRED TO USE THIS CMD. PURCHASE PREMIUM /buy TO USE THIS BOT.");
$webhook_url = 'https://api.telegram.org/bot6480376909:AAHrIGcvxnfXHruZcWu6GGFRHI5j-5p0Z2I/setwebhook?url=https://chkv2.in/gift/index.php';
$botToken =  "6480376909:AAHrIGcvxnfXHruZcWu6GGFRHI5j-5p0Z2I";
...
{
    $url = "https://api.telegram.org/bot6480376909:AAHrIGcvxnfXHruZcWu6GGFRHI5j-5p0Z2I/" . $method;
    $ch = curl_init();
